...
public class Finance {
    ...
    static {
        final String classesPath = OsUtils.class.getClassLoader().getResource("").getPath();
        if (OsUtils.isWindows()) {
            System.load(classesPath + "sdk/win/libcrypto-1_1-x64.dll");
            System.load(classesPath + "sdk/win/libssl-1_1-x64.dll");
            System.load(classesPath + "sdk/win/libcurl-x64.dll");
            System.load(classesPath + "sdk/win/WeWorkFinanceSdk.dll");
        } else {
            System.loadLibrary(classesPath + "sdk/linux/libWeWorkFinanceSdk_Java.so");
        }
    }
}
