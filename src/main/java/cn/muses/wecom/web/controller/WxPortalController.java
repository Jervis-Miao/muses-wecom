package cn.muses.wecom.web.controller;
...
import cn.muses.wecom.config.WxCpConfig;
import cn.muses.wecom.exceptions.WeworkException;
...
public class WxPortalController {
    ...
    private WxCpXmlOutMessage route(Integer agentId, WxCpXmlMessage message) {
        try {
            return WxCpConfig.getRouters().get(agentId).route(message);
        } catch (Exception e) {
